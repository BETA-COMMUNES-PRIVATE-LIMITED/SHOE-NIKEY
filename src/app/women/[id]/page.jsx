...
import productsData from '@/data/womenProducts';
...
export default function ProductDetailPage() {
  ...
  const allProducts = [
    ...
    ...customProducts.filter((p) => p.section === 'women'),
  ];
  ...
  const inWishlist = product ? isInWishlist(product.id, 'women') : false;
      ...
      <div className="min-h-screen flex flex-col" style={{ backgroundColor: 'var(--bg-primary)' }}>
        ...
        <main className="flex-1 flex items-center justify-center px-4">
          <div className="text-center">
            ...
            <Link href="/women" className="text-sm underline" style={{ color: 'var(--accent-lime)' }}>Back to Women</Link>
          </div>
        </main>
      </div>
    );
  ...
  const handleToggleWishlist = () => {
    toggleWishlist({ ...product, section: 'women' });
  };
          ...
          <div className="flex flex-col-reverse md:flex-row gap-3 md:gap-4">
            ...
            <div className="relative w-full aspect-square rounded-2xl overflow-hidden" style={{ backgroundColor: 'var(--bg-card)' }}>
              ...
              <Image
                ...
                style={{
                  transform: currentImages[selectedImage]?.includes('slides3.png')
                    ? 'scale(1.15) translateX(-15%)'
                    : undefined,
                }}
                priority
              />
